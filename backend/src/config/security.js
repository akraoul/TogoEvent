...
const helmetConfig = helmet({
  ...
  // IE No Open
  // ieNoOpen: true, // Désactivé car déjà configuré par défaut

  // No Sniff
  // noSniff: true, // Désactivé car déjà configuré par défaut dans helmet
  ...
  // xDnsPrefetchControl: { allow: false }, // Désactivé car déjà configuré par défaut
